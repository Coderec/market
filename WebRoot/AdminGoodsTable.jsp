						...
						<div class="box-content">
							...
							<table border=1 sellpacing=0 cellpacing=0>
								...
								<s:if test="#session.session_isLogined=='true'">
									...
									<s:iterator value="goodses" status="status" var="x">
										<s:if test="#x.gvalid==0">
											<tr>

												<td><s:property value="#status.count" />
												<td><s:property value="#x.gname" /></td>
												<td><s:property value="#x.gcategory" /></td>
												<td><s:property value="#x.user.uname" /></td>
												<td><s:property value="#x.gvalid" /></td>
												<td style='width:8em' class="center">&nbsp;&nbsp;<a
													class="btn btn-info"
													href="<%=path%>/adminGoodsTable/adminGoodsTableAction_goodsTable.do?gid=<s:property value="#x.gid"/>&b=v&valid=<s:property value="#x.gvalid"/>">
														<i class="icon-edit icon-white"></i> <s:property
															value="#x.gvalid" /></td>
												<td style='width:8em' class="center">&nbsp;&nbsp; </a>
													&nbsp;&nbsp;<a class="btn btn-danger"
													href="<%=path%>/adminGoodsDetail/adminGoodsDetailAction_goodsDetails.do?gid=<s:property value="#x.gid"/>&b=d">
														<i class="icon-trash icon-white"></i> 查看评论
												</a></td>
												<td style='width:8em' class="center">&nbsp;&nbsp; </a>
													&nbsp;&nbsp;<a class="btn btn-danger"
													href="<%=path%>/adminGoodsTable/adminGoodsTableAction_goodsTable.do?gid=<s:property value="#x.gid"/>&b=d">
