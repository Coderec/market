<%@ page language="java"
	import="java.util.*,com.online.market.model.Admin,com.online.market.model.User"
	pageEncoding="UTF-8"%>
				...
				<s:if test="#session.session_isLogined=='true'">
					<div class="box span12">
						...
						<div class="box-content">
							...
							<%
								List<Admin> admins = (List<Admin>) request
						...
						<div class="box-content">
							...
							%>
							<td class="center">
							<a class="btn btn-info" href="<%=path%>/adminDetail/adminDetailAction_detail.do?uid=<%=user.getUid()%>"> <i
								class="icon-edit icon-white"></i>编辑
							</a><a class="btn btn-danger"
								href="<%=path%>/adminUserTable/adminUserTableAction_deleteUser.do?uid=<%=user.getUid()%>">
