...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=path%>/css/buy.css">
...
<div class="content">
    <p>你需要求购什么宝贝</p>
    <div class="post-form">
        <form action="<%=path%>/post/postAction_post.do?kind=n" method="post" class="demoform">
            <div class="fl side-left">
                ...
                <p class="place"><label>所在地</label><span class="nanhu"></span><span >南湖校区</span><span class="wenchang"></span><span>文昌</span></p>
            </div>
            <p class="fl fl10">
                <label class="fl" style="color:#3ab6f6">求购说明</label>
                <textarea name="description" id="textar" onfcus="this.innerHTML=' '">最多输入100字</textarea>
    ...
    <input type="image" src="<%=path%>/images/post-button.png" alt="submit" id="submit">
</div>
<div class="footer">
